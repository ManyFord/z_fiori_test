		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Dev",
									"targetURL": "#sapfioritest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapfioritest-display": {
								"semanticObject": "sapfioritest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapfioritest",
									"url": sap.ui.require.toUrl("sapfioritest")
								}
							}
						}
					}
